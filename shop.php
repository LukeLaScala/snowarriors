	...
	<body>
		...
		<div class="container">
			<div class="row">
				<div class="col l4">
					<p>Front of shirt</p>
					<img class="materialboxed" src="static/img/shirtfront.png" style="width: 200px">
				</div>
				<div class="col l4">
					<p>Back of shirt</p>
					<img class="materialboxed" src="static/img/shirtback.png" style="width: 238px">
				</div>
				<div class="col l4">
					<br>
					<p>lorem ipsuem dolor sit amet. lorem ipsuem dolor sit amet. lorem ipsuem dolor sit amet. lorem ipsuem dolor sit amet. lorem ipsuem dolor sit amet</p>
				</div>
			</div>
